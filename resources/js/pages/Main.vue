<template>
    <div>
        ...
        Todo:
        <ul>
            <li>На странице выполнения упражнения выводить максильно лучший твой результат по данному упражнению</li>
            <li>При записи результатов под полями ввода маленькими тегами выводить предыдущие результаты для быстрой подстановки</li>
